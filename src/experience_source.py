...
from typing import Iterator, Callable, Sequence, Optional
...
class ExperienceSource:
    ...
    def __iter__(self) -> Iterator[tuple[Experience, ...]]:
...
def group_list(items: list, lens: list[int]) -> list[list]:
    result = []
    cur_ofs = 0
    for g_len in lens:
...
class ExperienceSourceFirstLast(ExperienceSource):
    def __init__(
        ...
        super().__init__(env, agent, steps_count + 1, steps_delta, vectorized)
        self.gamma = gamma
